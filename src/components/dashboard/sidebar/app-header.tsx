...
export function AppHeader({ breadcrumbs }: { breadcrumbs: BreadcrumbsItemType[] }) {
  return (
    <header className="flex  shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear bg-accent/20">
